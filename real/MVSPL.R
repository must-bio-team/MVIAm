...
##### Input X and Y #####
X_view1 = read.table('/data/Data_meta_profile_view1.txt',header = TRUE, sep = "\t")
Gene = X_view1[,1]
X_view1 = data.matrix(t(X_view1[,-1]))

X_view2 = read.table('/data/Data_meta_profile_view2.txt',header = TRUE, sep = "\t")
Gene = X_view2[,1]
...
for(i in 1:View_num){
cvfit<-cv.glmnet(X[[i]][trainidx,],Y[trainidx],alpha=1,family="binomial",type.measure = "class") 
